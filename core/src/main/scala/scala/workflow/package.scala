...
package object workflow extends FunctorInstances with SemiIdiomInstances with IdiomInstances with SemiMonadInstances with MonadInstances with MonoidInstances {
